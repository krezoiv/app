...
import { PersonnelManagementRoutingModule } from './personnelManagement/personnel-management-routing.module';
...
const routes: Routes = [
  ...
  },
  {
    path: 'personal',
    loadChildren: () =>
      import('./personnelManagement/personnel-management.module').then((personnelManagement)=> personnelManagement.PersonnelManagementModule)
  }
...
@NgModule({
  ...
  imports: [
    ...
    PersonnelManagementRoutingModule  // Importar el módulo de rutas de empleado, usuarios
  ],
